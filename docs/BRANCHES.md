...
|---|---|---|
| `main` | Protected trunk. Always green, always installable. | **305 tests green** (core 283, desktop 12, android 10). Desktop installed and verified as `0.16.1-empty-book`. The APK is built at the same stamp but **not yet on the phone** — it disconnected during `0.12.0` and the Redmi still runs `0.11.0-desktop-design`. |
